...
macro(ct_gen_autotgt _sdir _bdir _target)
  ...
  if(_sources)
    ...
    configure_file(${CODE_TEMPLATE_CMAKE_DIR}/AutoTarget.cmake.in
    ...
    if(NOT EXISTS ${_sdir}/CMakeLists.txt)
      ...
      configure_file(${CODE_TEMPLATE_CMAKE_DIR}/CMakeLists.txt.in
...
macro(ct_gen_autodeps _sdir _bdir _target)
  ...
  if(_sources)
    ...
    configure_file(${CODE_TEMPLATE_CMAKE_DIR}/AutoTargetDeps.cmake.in
